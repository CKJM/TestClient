...
import static water.godcoder.util.EntityUtil.calculateLookAt;
...
public class HoleFiller extends Module {
    ...
    private boolean IsHole(BlockPos blockPos) {
        ...
        if ((mc.world.getBlockState(boost).getBlock() == Blocks.AIR
                ...
                && ((mc.world.getBlockState(boost3).getBlock() == Blocks.OBSIDIAN) || (mc.world.getBlockState(boost3).getBlock() == Blocks.BEDROCK) || (mc.world.getBlockState(boost3).getBlock() == Blocks.ENDER_CHEST))
                && ((mc.world.getBlockState(boost4).getBlock() == Blocks.OBSIDIAN) || (mc.world.getBlockState(boost4).getBlock() == Blocks.BEDROCK) || (mc.world.getBlockState(boost4).getBlock() == Blocks.ENDER_CHEST))
                && ((mc.world.getBlockState(boost5).getBlock() == Blocks.OBSIDIAN) || (mc.world.getBlockState(boost5).getBlock() == Blocks.BEDROCK) || (mc.world.getBlockState(boost5).getBlock() == Blocks.ENDER_CHEST))
                && ((mc.world.getBlockState(boost6).getBlock() == Blocks.OBSIDIAN) || (mc.world.getBlockState(boost6).getBlock() == Blocks.BEDROCK) || (mc.world.getBlockState(boost6).getBlock() == Blocks.ENDER_CHEST))
                && (mc.world.getBlockState(boost8).getBlock() == Blocks.AIR)
                && ((mc.world.getBlockState(boost9).getBlock() == Blocks.OBSIDIAN) || (mc.world.getBlockState(boost9).getBlock() == Blocks.BEDROCK) || (mc.world.getBlockState(boost9).getBlock() == Blocks.ENDER_CHEST)))) {
            return true;
        } else {
            return false;
        }
