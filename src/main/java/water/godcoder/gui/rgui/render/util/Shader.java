package water.godcoder.gui.rgui.render.util;

import java.util.HashMap;
import java.util.Map;

import static water.godcoder.gui.rgui.render.util.ShaderHelper.createProgram;
import static water.godcoder.gui.rgui.render.util.ShaderHelper.loadShader;
