...
import water.godcoder.gui.kami.*;
import water.godcoder.gui.rgui.GUI;
...
import water.godcoder.gui.rgui.component.listen.MouseListener;
import water.godcoder.gui.rgui.component.listen.UpdateListener;
import water.godcoder.gui.rgui.poof.use.FramePoof;
...
import water.godcoder.util.Bind;
import water.godcoder.util.ColourHolder;
...
public class KamiFrameUI<T extends Frame> extends AbstractComponentUI<Frame> {
    ...
    ColourHolder frameColour = KamiGUI.primaryColour.setA(100);      CFontRenderer cFontRenderer = new CFontRenderer(new Font("Verdana", 0, 18), true, true);
    ...
    public void renderComponent(Frame component, FontRenderer fontRenderer) {
        ...
        GL11.glEnable(3042);
        GL11.glEnable(3553);
        this.cFontRenderer.drawString(component.getTitle(), (float)(component.getWidth() / 8 - this.cFontRenderer.getStringWidth(component.getTitle()) / 10), 1.0F, Color.LIGHT_GRAY.getRGB());
        GL11.glEnable(2884);
        GL11.glDisable(3042);
        GL11.glDisable(3553);
